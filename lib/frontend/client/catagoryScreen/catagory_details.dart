...
class catagory_details extends StatefulWidget {
  String catagory;
  catagory_details({super.key, required this.catagory});

  @override
  State<catagory_details> createState() => _catagory_detailsState();
}

class _catagory_detailsState extends State<catagory_details> {
