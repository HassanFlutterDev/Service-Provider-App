...
import 'package:abid/frontend/client/favServices/fav_service.dart';
...
class profile_client extends StatefulWidget {
  const profile_client({super.key});

  @override
  State<profile_client> createState() => _profile_clientState();
}
                  ...
                  Positioned(
                      ...
                      child: GestureDetector(
                        onTap: () {
                          Get.to(
                            ProfileEdit(
                                url: userData['photoUrl'], isLabor: false),
