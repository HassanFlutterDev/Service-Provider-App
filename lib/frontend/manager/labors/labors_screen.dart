...
class AllLaborsManager extends StatefulWidget {
  const AllLaborsManager({super.key});

  @override
  State<AllLaborsManager> createState() => _AllLaborsManagerState();
}

class _AllLaborsManagerState extends State<AllLaborsManager> {
